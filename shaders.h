...
Color fragmentShaderNave(Fragment& fragment) {
    Color colorNave(255, 105, 180);
    Color finalColor = colorNave;
    fragment.color = finalColor * fragment.intensity; // Red color with full opacity
    return fragment.color;
}